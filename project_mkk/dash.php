    ...
    <div class="mt-[18rem] mr-[4rem] -ml-[13rem]">
      <div class="grid grid-cols-4 gap-6">
        ...
        <article
          ...
          <a href="dash-guru.html" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-blue-600">
            Lebih Lanjut
        ...
        <article
          ...
          <a href="dash-input.php" class="group mt-4 inline-flex items-center gap-1 text-sm font-medium text-blue-600">
            Lebih Lanjut
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr>
              ...
              <td class="whitespace-nowrap px-4 py-2">
                <a href="dash-edit.php?nisn=<?php echo $siswa[0]; ?>"
